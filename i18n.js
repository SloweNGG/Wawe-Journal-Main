// ============================================================
// WAWE JOURNAL – i18n.js (ADD TRADE EKSİK ÇEVİRİLER EKLENDİ)
...
const translations = {
  en: {
    ...
    // ⭐ PLANS SHOW/HIDE FEATURES - EKLENDİ
    ...
    // Dashboard Calendar (Mini Takvim)
    ...
    // ⭐ STRATEGIES DETAIL - YENİ EKLENDİ
    ...
    // ⭐ STRATEGIES DETAIL METRICS - YENİ EKLENDİ
    ...
    // ⭐ OVER TRADE UYARI MESAJLARI - İNGİLİZCE
  ...
  tr: {
    ...
    // ⭐ PLANS SHOW/HIDE FEATURES - TÜRKÇE
    ...
    // ⭐ STRATEGIES DETAIL - TÜRKÇE EKLENDİ
    ...
    // ⭐ STRATEGIES DETAIL METRICS - TÜRKÇE EKLENDİ
    "strategies.detail.profit_factor": "Profit Factor",
    ...
    // ⭐ OVER TRADE UYARI MESAJLARI - TÜRKÇE
  ...
  de: {
    ...
    "hero.subtitle": "Wawe Journal ist dein professionelles Trading-Tagebuch, in dem du jeden Trade aufzeichnest, deine Analysen siehst und deine Disziplin aufbaust.",
    "hero.start_free": "Kostenlos Starten →",
    "hero.login": "Anmelden",
    "hero.win_rate": "WIN RATE",
    "hero.total_pnl": "GESAMT P&L",
    "hero.current_price": "XAUUSD",
    "stats.total_users": "Gesamt Nutzer",
    "stats.total_trades": "Gesamt Trades",
    "stats.today_users": "Heute Neu",
    "stats.today_trades": "Heutige Trades",
    "quotes": [
      ...
      "Wenn du deine Verluste kontrollieren kannst, kümmern sich deine Gewinne um sich selbst",
      "Der beste Trader ist der, der seine Emotionen kontrollieren kann",
      "Es geht nicht darum, Gewinn zu machen, sondern sich an deine Regeln zu halten",
      "Es geht nicht darum, in einem Trade recht zu haben, sondern Geld zu verdienen",
      "Handeln ohne Plan ist wie Segeln ohne Kompass",
      "Verlasse einen Trade, von dem du weißt, dass du ihn sofort verlieren wirst",
      "Disziplin ist es, was erfolgreiche Trader vom Rest unterscheidet",
      "Der Markt hat immer recht, kämpfe nicht gegen ihn",
      "Geduld ist die stärkste Waffe eines Traders",
      "Angst und Gier bewegen die Märkte, aber Wissen bewegt dich",
      "Jeder verlierende Trade ist eine Lektion, keine Niederlage",
      "Kontrolliere deine Emotionen, oder sie werden dich kontrollieren",
    ...
    "features.title": "Das <em>Trader</em>-Werkzeug zum Gewinnen",
    "features.desc": "Entwickelt nicht nur zum Aufzeichnen — sondern zum Verstehen, Verbessern und Übertreffen.",
    "feature.trade_log.title": "Trade-Log",
    ...
    "feature.strategy.desc": "Siehe, welche Strategie profitabler ist, mit Diagrammen.",
    
    // ⭐ PLANS SECTION - DEUTSCH
    "plans.tag": "💎 Preise",
    "plans.title": "Ein <em>Plan</em> für Jeden",
    "plans.desc": "Egal ob du gerade erst anfängst oder ein professioneller Trader bist — wähle den Plan, der zu dir passt.",
    ...
    "plans.premium_feature1": "Alle Free-Funktionen",
    "plans.premium_feature2": "Premium Dashboard",
    "plans.premium_feature3": "Drag & Drop Panels",
    "plans.premium_feature4": "Erweiterte Diagramme",
    "plans.premium_feature5": "Theme-Anpassung",
    "plans.premium_feature6": "Detaillierter PDF-Bericht",
    "plans.premium_feature7": "Premium News-Feed",
    "plans.premium_feature8": "Multi-Währungsunterstützung",
    ...
    "footer.desc": "Modernes Trading-Journal für professionelle Trader. Erfasse deine Trades, analysiere und verfolge deinen Fortschritt.",
    "footer.links": "Links",
    ...
    "settings.dark_theme": "Dunkles Thema",
    "settings.dark_theme_desc": "Augenfreundliche dunkle Oberfläche",
    "settings.light_theme": "Helles Thema",
    ...
    "settings.delete_all_trades_warning": "Alle deine Trade-Daten werden dauerhaft gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.",
    "settings.delete_data": "Daten Löschen",
    "settings.deactivate_account": "Konto deaktivieren",
    "settings.deactivate_account_warning": "Dein Konto wird deaktiviert und du kannst dich nicht mehr anmelden. Deine Daten werden gespeichert.",
    "settings.deactivate": "Konto Deaktivieren",
    "settings.confirm_title": "⚠️ Warnung!",
    "settings.confirm_message": "Diese Aktion kann nicht rückgängig gemacht werden. Bist du sicher, dass du fortfahren möchtest?",
    "settings.confirm_cancel": "Abbrechen",
    "settings.confirm_ok": "Ja, Deaktivieren",
    "settings.uploading": "Laden...",
    "settings.current_password_placeholder": "••••••••",
    ...
    "language.applying": "Sprache wird angewendet...",
    ...
    "dashboard.stats.total_trades": "Gesamt Trades",
    ...
    "dashboard.chart.winloss": "Gewinn/Verlust Verteilung",
    "dashboard.chart.daily": "Täglicher P&L – Letzte 30 Tage",
    "dashboard.chart.symbol": "Symbol Performance",
    "dashboard.chart.direction": "Long/Short Verteilung",
    "dashboard.streak.title": "LETZTE 20 TRADES SERIE",
    "dashboard.streak.win_streak": "Trade Gewinnserie",
    "dashboard.streak.loss_streak": "Trade Verlustserie",
    "dashboard.streak.no_trades": "noch keine Trades",
    "dashboard.trend_previous": "im Vergleich zur Vorperiode",
    "dashboard.strategies.title": "VERWENDETE STRATEGIEN",
    "dashboard.no_strategies": "Noch keine Strategien verwendet",
    "dashboard.no_strategies_found": "Strategieinformation nicht gefunden",
    "dashboard.total_strategies": "Insgesamt verwendete Strategien:",
    ...
    "dashboard.pdf_lang_desc": "PDF-Berichtssprache auswählen",
    ...
    "dashboard.calendar.view_detail": "Detailansicht →",
    ...
    "trades.no_notes": "Keine Notiz hinzugefügt",
    "trades.open": "Offen",
    ...
    "trades.total_count": "Insgesamt {{count}} Trades",
    "trades.th_symbol": "Symbol",
    ...
    // Trades - Pagination
    "trades.pagination.showing": "Anzeigen",
    "trades.pagination.of": "/",
    "trades.pagination.trades": "Trades",
    ...
    "strategies.title_em": "Panel",
    "strategies.subtitle": "Verfolgen Sie die Performance all Ihrer Trading-Strategien.",
    "strategies.add_button": "Strategie hinzufügen",
    "strategies.summary.total_strategies": "Gesamt Strategien",
    "strategies.summary.total_trades": "Gesamt Trades",
    ...
    // ⭐ STRATEGIES DETAIL - ALMANCA EKLENDİ
    "strategies.detail.instrument_breakdown": "Instrumentenaufschlüsselung",
    "strategies.detail.trade_list": "Handelsliste",
    ...
    // ⭐ STRATEGIES DETAIL METRICS - ALMANCA EKLENDİ
    ...
    "addtrade.subtitle": "Handelsdetails eingeben, Echtzeit-P&L-Berechnung anzeigen",
    ...
    "addtrade.import_processing": "Verarbeitung...",
    "addtrade.csv_no_data": "Keine Daten in CSV-Datei gefunden!",
    "addtrade.section_trade_details": "Handelsdetails",
    ...
    "addtrade.long": "Long · Kauf",
    "addtrade.short": "Short · Verkauf",
    ...
    "addtrade.select_strategy": "— Strategie auswählen —",
    "addtrade.select_strategy_label": "Strategie auswählen",
    ...
    "addtrade.estimated_pnl": "Geschätzter P&L",
    "addtrade.risk_reward": "Risiko / Belohnung",
    ...
    "addtrade.loading_strategies": "Strategien werden geladen...",
    ...
    "addtrade.bulk_import_format": "symbol,richtung,lot,einstieg,ausstieg,datum,notiz",
    ...
    "addtrade.bulk_import_processing": "Verarbeitung...",
    ...
    "addtrade.bulk_import_required": "Bitte mindestens einen Trade eingeben!",
    "addtrade.bulk_import_invalid": "Ungültiges Format in Zeile {{line}}: {{error}}",
    
    // Login
    "login.welcome_back": "Willkommen zurück",
    "login.no_account": "Du hast kein Konto? ",
    "login.register_link": "Registrieren",
    "login.email": "E-Mail",
    "login.email_placeholder": "trader@example.com",
    "login.password": "Passwort",
    "login.password_placeholder": "Dein Passwort",
    ...
    "login.error_invalid_email": "Bitte gib eine gültige E-Mail-Adresse ein.",
    "login.error_wrong_credentials": "Ungültige E-Mail oder Passwort.",
    "login.error_account_disabled": "Dein Konto wurde deaktiviert.",
    
    // Register
    "register.title": "Konto erstellen",
    "register.have_account": "Du hast bereits ein Konto? ",
    ...
    "register.terms": "Mit der Registrierung stimmst du unseren ",
    ...
    "register.error_invalid_email": "Bitte gib eine gültige E-Mail-Adresse ein.",
    ...
    // Toast
    "toast.invalid_image": "Bitte wähle eine gültige Bilddatei!",
    ...
    "calendar.subtitle": "Alle deine Trades monatlich anzeigen",
    ...
    "overtrade.all_good_desc": "Du hast heute keine Over Trade-Limits überschritten.",
    "overtrade.daily_trades": "Täglich",
    "overtrade.weekly_trades": "Wöchentlich",
    "overtrade.loss": "Verlust",
    "overtrade.info": "Information",
    "overtrade.warning": "Warnung",
    "overtrade.danger": "Kritisch",
    "overtrade.title": "Over Trade Warnungen",
    "overtrade.desc": "Premium erweitertes Handelswarnsystem",
    ...
    // ⭐ OVER TRADE UYARI MESAJLARI - ALMANCA
    "overtrade.daily_limit_warning": "Du hast heute {{current}} Trades gemacht. Dein tägliches Limit ist {{limit}}!",
    "overtrade.weekly_limit_warning": "Du hast diese Woche {{current}} Trades gemacht. Dein wöchentliches Limit ist {{limit}}!",
    "overtrade.daily_loss_warning": "Du hast heute {{loss}} verloren. Dein tägliches Verlustlimit ist ${{limit}}!"
  }
};

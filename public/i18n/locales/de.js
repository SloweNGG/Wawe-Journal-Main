...
export default {
  ...
  "login.error_account_disabled": "Ihr Konto wurde deaktiviert.",
    "auth.too_many_attempts": "Zu viele Versuche. Bitte später erneut versuchen.",
  "auth.verification_required": "Bitte schließen Sie die Verifizierung ab.",
  "auth.verification_failed": "Verifizierung fehlgeschlagen. Bitte erneut versuchen.",
  "auth.network_error": "Netzwerkfehler. Bitte erneut versuchen.",
  "auth.email_taken": "Diese E-Mail ist bereits registriert.",
  "auth.username_taken": "Dieser Benutzername ist bereits vergeben.",
  "auth.register_success": "Registrierung erfolgreich! Sie können sich jetzt anmelden.",
  "auth.register_failed": "Registrierung fehlgeschlagen. Bitte erneut versuchen.",
  "auth.account_deactivated": "Ihr Konto wurde deaktiviert.",
  "auth.generic_login_error": "Anmeldung fehlgeschlagen. Bitte erneut versuchen.",
  ...
  "journal.title": "Meine Konten",
  "journal.subtitle": "Trennen Sie Ihre Trades in Konten und verfolgen Sie die Leistung",
  "journal.new_button": "Neues Konto",
  "journal.manage": "Konten Verwalten",
  "journal.usage": "{used} / {limit} Konten verwendet",
  "journal.default_badge": "Hauptkonto",
  "journal.trades_count": "{count} Trades",
  "journal.strategies_count": "{count} Strategien",
  "journal.total_pnl": "Gesamt G/V",
  "journal.win_rate": "Erfolgsquote",
  "journal.last_trade": "Letzter Trade",
  "journal.empty": "Noch keine Konten",
  "journal.create_title": "Neues Konto Erstellen",
  "journal.edit_title": "Konto Bearbeiten",
  "journal.delete_title": "Konto Löschen",
  "journal.delete_message": "Sind Sie sicher, dass Sie dieses Konto löschen möchten? Die {tradeCount} Trades und {strategyCount} Strategien werden in Ihr Hauptkonto verschoben.",
  "journal.name_label": "Kontoname",
  "journal.name_placeholder": "z.B. Scalping, Swing, Prop Firm",
  "journal.description_label": "Beschreibung (optional)",
  "journal.color_label": "Farbe",
  "journal.icon_label": "Symbol",
  "journal.save": "Speichern",
  "journal.cancel": "Abbrechen",
  "journal.delete_confirm": "Ja, Löschen",
  "journal.set_default": "Als Standard festlegen",
  "journal.edit": "Bearbeiten",
  "journal.delete": "Löschen",
  "journal.err_quota": "Kontolimit erreicht. Upgraden Sie auf Premium für bis zu 5 Konten.",
  "journal.err_invalid_name": "Der Kontoname muss zwischen 1 und 60 Zeichen lang sein.",
  "journal.err_not_found": "Konto nicht gefunden.",
  "journal.err_cannot_delete_default": "Das Hauptkonto kann nicht gelöscht werden.",
  "journal.err_cannot_delete_last": "Sie können Ihr letztes Konto nicht löschen.",
  ...
  "earnings.btn_wallets": "Meine Wallet-Adressen",
  "earnings.btn_request_payout": "Auszahlung anfordern",
  ...
  "earnings.stat_available": "Verfügbares Guthaben",
  "earnings.min_payout_note": "Mindestauszahlung: $20.00",
  "earnings.stat_earnings": "Gesamteinnahmen",
  "earnings.stat_earnings_sub": "Gesamterlös aller Zeiten",
  "earnings.stat_usage": "Gesamtnutzung",
  "earnings.stat_usage_sub": "{count} Gesamtnutzungen",
  "earnings.stat_pending": "Ausstehende Auszahlungen",
  "earnings.pending_sub": "Wartet auf Admin-Bestätigung",
  "earnings.stat_paid": "Gesamt ausgezahlt",
  "earnings.paid_sub": "Abgeschlossene Auszahlungen",
  "earnings.table_title": "Ihre zugewiesenen Empfehlungscodes",
  "earnings.table_subtitle": "Bei jedem Abonnementkauf mit Ihrem Code wird Ihrem Konto eine Provision gutgeschrieben",
  "earnings.col_code": "Code",
  "earnings.col_discount": "Rabatt",
  "earnings.col_usage": "Abonnementkäufe",
  "earnings.col_commission": "Provision / Verkauf",
  "earnings.col_total": "Gesamteinnahmen",
  "earnings.no_codes": "Keine zugewiesenen Empfehlungscodes gefunden.",
  "earnings.orders_unit": "Bestellungen",
  "earnings.payouts_history_title": "Auszahlungshistorie",
  "earnings.btn_refresh": "Aktualisieren",
  "earnings.col_date": "Datum",
  "earnings.col_amount": "Betrag ($)",
  "earnings.col_method": "Methode",
  "earnings.col_address": "Wallet-Adresse",
  "earnings.col_status": "Status",
  "earnings.col_note": "Notiz / Beschreibung",
  "earnings.status_pending": "⏳ Ausstehend",
  "earnings.status_approved": "✅ Ausgezahlt",
  "earnings.status_rejected": "❌ Abgelehnt",
  "earnings.no_payouts": "Sie haben noch keine Auszahlungsanfragen.",
  "earnings.modal_payout_title": "Auszahlungsanfrage",
  "earnings.min_payout": "Mindestauszahlung",
  "earnings.payout_method_label": "AUSZAHLUNGSMETHODE",
  "earnings.ltc_low_fee": "Niedrige Netzwerkgebühren",
  "earnings.btc_network": "BTC-Netzwerk",
  "earnings.withdraw_amount_label": "AUSZAHLUNGSBETRAG ($)",
  "earnings.withdraw_all": "Alles auszahlen",
  "earnings.min_amount_warning": "Der Mindestauszahlungsbetrag beträgt 20.00 $.",
  "earnings.payout_address_label_suffix": "WALLET-ADRESSE",
  "earnings.save_address_label": "Diese Adresse in meinem Profil speichern (wird bei nächsten Anfragen automatisch ausgefüllt)",
  "earnings.btn_submit_request": "Anfrage senden",
  "earnings.modal_wallets_title": "Meine gespeicherten Wallet-Adressen",
  "earnings.modal_wallets_desc": "Ihre Wallet-Adressen werden bei Auszahlungsanfragen automatisch ausgefüllt. Sie können sie jederzeit aktualisieren.",
  "earnings.ltc_address_label": "Litecoin (LTC) Adresse",
  "earnings.btc_address_label": "Bitcoin (BTC) Adresse",
  "earnings.toast_min_amount": "Der Mindestauszahlungsbetrag muss 20.00 $ betragen.",
  "earnings.toast_insufficient_balance": "Unzureichendes Guthaben. Maximal verfügbar: $",
  "earnings.toast_invalid_address": "Bitte geben Sie eine gültige Wallet-Adresse ein.",
  "earnings.toast_payout_success": "Auszahlungsanfrage erfolgreich eingereicht! Die Überweisung erfolgt nach Admin-Freigabe.",
  "earnings.toast_wallets_saved": "Wallet-Adressen erfolgreich gespeichert!",
  "earnings.toast_code_copied": "Empfehlungscode kopiert!",
  "earnings.toast_address_copied": "Wallet-Adresse kopiert!",
  "earnings.partner_badge": "WJ PARTNERPROGRAMM",
  "earnings.partner_hero_title": "Bauen Sie Ihre Community auf, verdienen Sie an jedem Verkauf",
  "earnings.partner_hero_desc": "Verdienen Sie passives Einkommen, indem Sie Trader für das Wawe Journal-Ökosystem begeistern. Transparente Provisionen und Krypto-Auszahlungen.",
  "earnings.step1_title": "1. Erhalten Sie Ihren Code",
  "earnings.step1_desc": "Nach der Freigabe erhalten Sie einen individuellen Rabattcode für Ihre Community.",
  "earnings.step2_title": "2. Teilen & Wachsen",
  "earnings.step2_desc": "Ihre Follower abonnieren vergünstigt und heben ihr Trading auf das nächste Level.",
  "earnings.step3_title": "3. Krypto-Auszahlungen",
  "earnings.step3_desc": "Verdienen Sie bei jedem Verkauf eine feste $-Provision und heben Sie diese jederzeit in BTC oder LTC ab.",
  "earnings.btn_apply_partner": "Partnerprogramm beantragen",
  "earnings.btn_reapply_partner": "Neue Bewerbung einreichen",
  "earnings.app_pending_title": "Bewerbung wird geprüft",
  "earnings.app_pending_desc": "Ihre Bewerbung wird von unserem Team geprüft. Die durchschnittliche Bearbeitungszeit beträgt 24-48 Stunden.",
  "earnings.app_rejected_title": "Bewerbung nicht genehmigt",
  "earnings.app_reapply_countdown": "Verbleibende Zeit bis zur erneuten Bewerbung: {{days}} Tage",
  "earnings.admin_reason": "Admin-Notiz:",
  "earnings.modal_apply_title": "WJ Partnerbewerbung",
  "earnings.modal_apply_desc": "Erzählen Sie uns von Ihrer Trading-Community oder Ihrem Publikum. Bewerbungen werden innerhalb von 24-48 Stunden geprüft.",
  "earnings.field_instagram": "Instagram-Profil / Handle",
  "earnings.field_instagram_placeholder": "@benutzername oder instagram.com/benutzername",
  "earnings.field_followers": "Follower- / Community-Größe",
  "earnings.followers_opt_1": "1.000 - 5.000 Follower",
  "earnings.followers_opt_2": "5.000 - 20.000 Follower",
  "earnings.followers_opt_3": "20.000 - 50.000 Follower",
  "earnings.followers_opt_4": "50.000+ Follower",
  "earnings.field_crypto": "Nutzen Sie Kryptowährungen?",
  "earnings.field_crypto_desc": "Partnerprovisionen werden über Bitcoin- und Litecoin-Netzwerke ausgezahlt.",
  "earnings.crypto_yes": "Ja, ich nutze Krypto aktiv",
  "earnings.crypto_no": "Nein, noch nicht",
  "earnings.field_note": "Kurze Vorstellung / Notiz",
  "earnings.field_note_placeholder": "Kurze Informationen über Ihre Inhalte, Analysen und Ihre Community...",
  "earnings.btn_submit_app": "Bewerbung absenden",
  "earnings.toast_app_submitted": "Partnerbewerbung erfolgreich eingereicht! Der Status wird hier angezeigt.",
  "earnings.toast_instagram_required": "Bitte geben Sie Ihr Instagram-Profil ein.",
  "earnings.toast_followers_required": "Bitte wählen Sie Ihre Follower-Größe aus."
};

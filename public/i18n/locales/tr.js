...
export default {
  ...
  // NOTIFICATIONS
  "noti.empty_title": "Yeni Bildirim Yok",
  "noti.empty_desc": "Şu an için her şey yolunda görünüyor.",
  "noti.just_now": "Şimdi",
  "noti.hours_ago": "{h} saat önce",
  "noti.days_ago": "{d} gün önce",
  "noti.system_welcome_title": "Hoş Geldiniz!",
  "noti.system_welcome_desc": "Aramıza katıldığınız için teşekkürler. İlk işleminizi girmeye başlayabilirsiniz.",
  "noti.premium_welcome_title": "Premium'a Hoş Geldiniz!",
  "noti.premium_welcome_desc": "Tüm profesyonel araçların kilidi açıldı.",
  "noti.premium_expiring_title": "Premium Süresi Bitiyor",
  "noti.premium_expiring_desc": "Premium üyeliğinizin bitmesine 24 saat kaldı.",
  "noti.partner_approved_title": "Partner Başvurunuz Onaylandı!",
  "noti.partner_approved_desc": "WJ Partner programına hoş geldiniz. Kazanç elde etmeye başlayabilirsiniz.",
  "noti.partner_rejected_title": "Başvurunuz Reddedildi",
  "noti.partner_rejected_desc": "Partner başvurunuz maalesef onaylanmadı.",
  "noti.payout_approved_title": "Ödeme Talebi Onaylandı",
  "noti.payout_approved_desc": "{amount}$ değerindeki ödeme talebiniz cüzdanınıza gönderildi.",
  "noti.payout_rejected_title": "Ödeme Talebi Reddedildi",
  "noti.payout_rejected_desc": "{amount}$ değerindeki ödeme talebiniz reddedildi.",
  "noti.overtrade_warning_title": "Risk Uyarısı",
  "noti.overtrade_warning_desc": "Over-trade limitinize yaklaştınız, lütfen riskinizi yönetin.",
  ...
  "login.error_account_disabled": "Hesabınız devre dışı bırakılmıştır.",
    "auth.too_many_attempts": "Çok fazla deneme. Lütfen daha sonra tekrar deneyin.",
  "auth.verification_required": "Lütfen doğrulamayı tamamlayın.",
  "auth.verification_failed": "Doğrulama başarısız. Lütfen tekrar deneyin.",
  "auth.network_error": "Ağ hatası. Lütfen tekrar deneyin.",
  "auth.email_taken": "Bu e-posta zaten kayıtlı.",
  "auth.username_taken": "Bu kullanıcı adı zaten alınmış.",
  "auth.register_success": "Kayıt başarılı! Giriş yapabilirsiniz.",
  "auth.register_failed": "Kayıt başarısız. Lütfen tekrar deneyin.",
  "auth.account_deactivated": "Hesabınız devre dışı bırakılmıştır.",
  "auth.generic_login_error": "Giriş başarısız. Lütfen tekrar deneyin.",
  ...
  "journal.manage": "Hesapları Yönet",
  "journal.usage": "{used} / {limit} hesap kullanılıyor",
  "journal.default_badge": "Ana Hesap",
  "journal.trades_count": "{count} işlem",
  "journal.strategies_count": "{count} strateji",
  "journal.total_pnl": "Toplam K/Z",
  "journal.win_rate": "Başarı Oranı",
  "journal.last_trade": "Son İşlem",
  "journal.empty": "Henüz hesap yok",
  "journal.create_title": "Yeni Hesap Oluştur",
  "journal.edit_title": "Hesabı Düzenle",
  "journal.delete_title": "Hesabı Sil",
  "journal.delete_message": "Bu hesabı silmek istediğine emin misin? İçindeki {tradeCount} işlem ve {strategyCount} strateji varsayılan hesaba taşınacak.",
  "journal.name_label": "Hesap Adı",
  "journal.name_placeholder": "Örn: Scalping, Swing, Prop Firm",
  "journal.description_label": "Açıklama (opsiyonel)",
  "journal.color_label": "Renk",
  "journal.icon_label": "İkon",
  "journal.save": "Kaydet",
  "journal.cancel": "İptal",
  "journal.delete_confirm": "Evet, Sil",
  "journal.set_default": "Varsayılan Yap",
  "journal.edit": "Düzenle",
  "journal.delete": "Sil",
  "journal.err_quota": "Hesap limitine ulaştın. Premium ile 5 hesaba çıkarabilirsin.",
  "journal.err_invalid_name": "Hesap adı 1-60 karakter arasında olmalı.",
  "journal.err_not_found": "Hesap bulunamadı.",
  "journal.err_cannot_delete_default": "Varsayılan hesap silinemez.",
  "journal.err_cannot_delete_last": "Son hesabı silemezsin.",
  ...
  "earnings.subtitle": "Referans komisyonlarınızı yönetin ve çekim talebi oluşturun",
  "earnings.btn_wallets": "Cüzdan Adreslerim",
  "earnings.btn_request_payout": "Para Çekme Talebi Gönder",
  ...
  "earnings.stat_available": "Çekilebilir Bakiye",
  "earnings.min_payout_note": "Minimum çekim: $20.00",
  "earnings.stat_earnings": "Toplam Kazanç",
  "earnings.stat_earnings_sub": "Tüm zamanların toplamı",
  "earnings.stat_usage": "Toplam Kullanım",
  "earnings.stat_usage_sub": "{count} toplam kullanım",
  "earnings.stat_pending": "Bekleyen Talepler",
  "earnings.pending_sub": "Admin onayı bekleniyor",
  "earnings.stat_paid": "Toplam Ödenen",
  "earnings.paid_sub": "Tamamlanan çekimler",
  "earnings.table_title": "Tanımlı Referans Kodlarınız",
  "earnings.table_subtitle": "Abonelik alımlarında kodunuz kullanıldıkça komisyon hesabınıza işlenir",
  "earnings.col_code": "Kod",
  "earnings.col_discount": "Kullanıcı İndirimi",
  "earnings.col_usage": "Abonelik Alımları",
  "earnings.col_commission": "Komisyon / Satış",
  "earnings.col_total": "Toplam Kazanç",
  "earnings.no_codes": "Tanımlı referans kodu bulunamadı.",
  "earnings.orders_unit": "adet",
  "earnings.payouts_history_title": "Para Çekme Talepleri Geçmişi",
  "earnings.btn_refresh": "Yenile",
  "earnings.col_date": "Tarih",
  "earnings.col_amount": "Tutar ($)",
  "earnings.col_method": "Yöntem",
  "earnings.col_address": "Cüzdan Adresi",
  "earnings.col_status": "Durum",
  "earnings.col_note": "Not / Açıklama",
  "earnings.status_pending": "⏳ Beklemede",
  "earnings.status_approved": "✅ Ödendi",
  "earnings.status_rejected": "❌ Reddedildi",
  "earnings.no_payouts": "Henüz bir para çekme talebiniz bulunmuyor.",
  "earnings.modal_payout_title": "Para Çekme Talebi",
  "earnings.min_payout": "Minimum Çekim",
  "earnings.payout_method_label": "ÇEKİM YÖNTEMİ",
  "earnings.ltc_low_fee": "Düşük ağ ücreti",
  "earnings.btc_network": "BTC ağı",
  "earnings.withdraw_amount_label": "ÇEKİLECEK TUTAR ($)",
  "earnings.withdraw_all": "Tümünü Çek",
  "earnings.min_amount_warning": "Minimum çekilebilir tutar $20.00'dır.",
  "earnings.payout_address_label_suffix": "CÜZDAN ADRESİNİZ",
  "earnings.save_address_label": "Bu adresi profilime kaydet (sonraki çekimlerde otomatik gelir)",
  "earnings.btn_submit_request": "Talebi Gönder",
  "earnings.modal_wallets_title": "Kayıtlı Cüzdan Adreslerim",
  "earnings.modal_wallets_desc": "Para çekme taleplerinizde cüzdan adresleriniz otomatik olarak doldurulur. İstediğiniz zaman güncelleyebilirsiniz.",
  "earnings.ltc_address_label": "Litecoin (LTC) Adresi",
  "earnings.btc_address_label": "Bitcoin (BTC) Adresi",
  "earnings.toast_min_amount": "Minimum çekim tutarı $20.00 olmalıdır.",
  "earnings.toast_insufficient_balance": "Yetersiz bakiye. Maksimum çekilebilir: $",
  "earnings.toast_invalid_address": "Lütfen geçerli bir cüzdan adresi girin.",
  "earnings.toast_payout_success": "Para çekme talebiniz başarıyla oluşturuldu! Admin onayından sonra cüzdanınıza transfer edilecektir.",
  "earnings.toast_wallets_saved": "Cüzdan adresleri başarıyla kaydedildi!",
  "earnings.toast_code_copied": "Referans kodu kopyalandı!",
  "earnings.toast_address_copied": "Cüzdan adresi kopyalandı!",
  "earnings.partner_badge": "WJ PARTNER PROGRAMI",
  "earnings.partner_hero_title": "Topluluğunuzu Büyütün, Her Satıştan Gelir Elde Edin",
  "earnings.partner_hero_desc": "Wawe Journal ekosistemine yeni traderlar kazandırarak düzenli pasif gelir elde edin. Şeffaf komisyon ve kripto ile anında çekim imkanı.",
  "earnings.step1_title": "1. Kodunuzu Alın",
  "earnings.step1_desc": "Başvurunuz onaylandığında takipçilerinize özel % indirim kodu ve size komisyon hakkı tanımlanır.",
  "earnings.step2_title": "2. Paylaşın & Kazandırın",
  "earnings.step2_desc": "Takipçileriniz indirimli fiyata abone olsun, profesyonel analiz araçlarıyla hesaplarını büyütsün.",
  "earnings.step3_title": "3. Kripto ile Çekin",
  "earnings.step3_desc": "Her abonelikten net $ komisyon kazanın, bakiyenizi dilediğiniz an BTC veya LTC ile çekin.",
  "earnings.btn_apply_partner": "Partner Başvurusu Yap",
  "earnings.btn_reapply_partner": "Yeni Başvuru Yap",
  "earnings.app_pending_title": "Başvurunuz Değerlendiriliyor",
  "earnings.app_pending_desc": "Partner başvurunuz ekibimiz tarafından incelenmektedir. Ortalama değerlendirme süresi 24-48 saattir.",
  "earnings.app_rejected_title": "Başvurunuz Onaylanmadı",
  "earnings.app_reapply_countdown": "Yeni başvuru yapabilmek için kalan süre: {{days}} gün",
  "earnings.admin_reason": "Yönetici Notu:",
  "earnings.modal_apply_title": "WJ Partner Başvurusu",
  "earnings.modal_apply_desc": "Trading topluluğunuz veya kitleniz hakkında bilgi verin. Başvurular 24-48 saat içinde değerlendirilir.",
  "earnings.field_instagram": "Instagram Adresiniz",
  "earnings.field_instagram_placeholder": "@kullaniciadi veya instagram.com/kullaniciadi",
  "earnings.field_followers": "Takipçi / Topluluk Boyutu",
  "earnings.followers_opt_1": "1.000 - 5.000 Takipçi",
  "earnings.followers_opt_2": "5.000 - 20.000 Takipçi",
  "earnings.followers_opt_3": "20.000 - 50.000 Takipçi",
  "earnings.followers_opt_4": "50.000+ Takipçi",
  "earnings.field_crypto": "Kripto para kullanıyor musunuz?",
  "earnings.field_crypto_desc": "Affiliate komisyon ödemeleri BTC ve LTC ağları üzerinden yapılmaktadır.",
  "earnings.crypto_yes": "Evet, aktif olarak kullanıyorum",
  "earnings.crypto_no": "Hayır, henüz kullanmıyorum",
  "earnings.field_note": "Kısa Not / Tanıtım",
  "earnings.field_note_placeholder": "İçerik türünüz, trading analizleriniz ve topluluğunuz hakkında kısa bilgi...",
  "earnings.btn_submit_app": "Başvuruyu Gönder",
  "earnings.toast_app_submitted": "Partner başvurunuz başarıyla alındı! Değerlendirme sonucu bu sayfada görünecektir.",
  "earnings.toast_instagram_required": "Lütfen Instagram adresinizi giriniz.",
  "earnings.toast_followers_required": "Lütfen takipçi kitlenizi seçiniz."
};

...
export default {
  ...
  // NOTIFICATIONS
  "noti.empty_title": "No New Notifications",
  "noti.empty_desc": "Everything looks good for now.",
  "noti.just_now": "Just now",
  "noti.hours_ago": "{h} hours ago",
  "noti.days_ago": "{d} days ago",
  "noti.system_welcome_title": "Welcome!",
  "noti.system_welcome_desc": "Thanks for joining us. You can start logging your first trade.",
  "noti.premium_welcome_title": "Welcome to Premium!",
  "noti.premium_welcome_desc": "All professional tools are now unlocked.",
  "noti.premium_expiring_title": "Premium Expiring",
  "noti.premium_expiring_desc": "Your Premium subscription will expire in 24 hours.",
  "noti.partner_approved_title": "Partner Application Approved!",
  "noti.partner_approved_desc": "Welcome to the WJ Partner program. You can start earning now.",
  "noti.partner_rejected_title": "Application Rejected",
  "noti.partner_rejected_desc": "Unfortunately, your partner application was not approved.",
  "noti.payout_approved_title": "Payout Approved",
  "noti.payout_approved_desc": "Your payout request of ${amount} has been sent to your wallet.",
  "noti.payout_rejected_title": "Payout Rejected",
  "noti.payout_rejected_desc": "Your payout request of ${amount} was rejected.",
  "noti.overtrade_warning_title": "Risk Warning",
  "noti.overtrade_warning_desc": "You are approaching your over-trade limit, please manage your risk.",
  ...
  "journal.title": "My Accounts",
  "journal.subtitle": "Separate your trades into accounts, track performance",
  "journal.new_button": "New Account",
  "journal.manage": "Manage Accounts",
  "journal.usage": "{used} / {limit} accounts used",
  "journal.default_badge": "Default Account",
  "journal.trades_count": "{count} trades",
  "journal.strategies_count": "{count} strategies",
  "journal.total_pnl": "Total P/L",
  "journal.win_rate": "Win Rate",
  "journal.last_trade": "Last Trade",
  "journal.empty": "No accounts yet",
  "journal.create_title": "Create New Account",
  "journal.edit_title": "Edit Account",
  "journal.delete_title": "Delete Account",
  "journal.delete_message": "Are you sure you want to delete this account? Its {tradeCount} trades and {strategyCount} strategies will be moved to your default account.",
  "journal.name_label": "Account Name",
  "journal.name_placeholder": "e.g., Scalping, Swing, Prop Firm",
  "journal.description_label": "Description (optional)",
  "journal.color_label": "Color",
  "journal.icon_label": "Icon",
  "journal.save": "Save",
  "journal.cancel": "Cancel",
  "journal.delete_confirm": "Yes, Delete",
  "journal.set_default": "Set as Default",
  "journal.edit": "Edit",
  "journal.delete": "Delete",
  "journal.err_quota": "Account limit reached. Upgrade to Premium for up to 5 accounts.",
  "journal.err_invalid_name": "Account name must be between 1 and 60 characters.",
  "journal.err_not_found": "Account not found.",
  "journal.err_cannot_delete_default": "Default account cannot be deleted.",
  "journal.err_cannot_delete_last": "You cannot delete your last account.",
  ...
  "earnings.btn_wallets": "My Wallet Addresses",
  "earnings.btn_request_payout": "Request Payout",
  ...
  "earnings.stat_available": "Available Balance",
  "earnings.min_payout_note": "Minimum withdrawal: $20.00",
  "earnings.stat_earnings": "Total Earnings",
  "earnings.stat_earnings_sub": "All-time total earnings",
  "earnings.stat_usage": "Total Usage",
  "earnings.stat_usage_sub": "{count} total uses",
  "earnings.stat_pending": "Pending Payouts",
  "earnings.pending_sub": "Awaiting admin approval",
  "earnings.stat_paid": "Total Paid",
  "earnings.paid_sub": "Completed payouts",
  "earnings.table_title": "Your Assigned Referral Codes",
  "earnings.table_subtitle": "Commission is credited to your account whenever your code is used for subscription purchases",
  "earnings.col_code": "Code",
  "earnings.col_discount": "User Discount",
  "earnings.col_usage": "Subscriptions Sold",
  "earnings.col_commission": "Commission / Sale",
  "earnings.col_total": "Total Earnings",
  "earnings.no_codes": "No assigned referral codes found.",
  "earnings.orders_unit": "orders",
  "earnings.payouts_history_title": "Payout Request History",
  "earnings.btn_refresh": "Refresh",
  "earnings.col_date": "Date",
  "earnings.col_amount": "Amount ($)",
  "earnings.col_method": "Method",
  "earnings.col_address": "Wallet Address",
  "earnings.col_status": "Status",
  "earnings.col_note": "Note / Description",
  "earnings.status_pending": "⏳ Pending",
  "earnings.status_approved": "✅ Paid",
  "earnings.status_rejected": "❌ Rejected",
  "earnings.no_payouts": "You don't have any payout requests yet.",
  "earnings.modal_payout_title": "Payout Request",
  "earnings.min_payout": "Minimum Payout",
  "earnings.payout_method_label": "PAYOUT METHOD",
  "earnings.ltc_low_fee": "Low network fee",
  "earnings.btc_network": "BTC network",
  "earnings.withdraw_amount_label": "WITHDRAWAL AMOUNT ($)",
  "earnings.withdraw_all": "Withdraw All",
  "earnings.min_amount_warning": "Minimum withdrawal amount is $20.00.",
  "earnings.payout_address_label_suffix": "WALLET ADDRESS",
  "earnings.save_address_label": "Save this address to my profile (auto-fills on next requests)",
  "earnings.btn_submit_request": "Submit Request",
  "earnings.modal_wallets_title": "My Saved Wallet Addresses",
  "earnings.modal_wallets_desc": "Your wallet addresses are auto-filled for payout requests. You can update them anytime.",
  "earnings.ltc_address_label": "Litecoin (LTC) Address",
  "earnings.btc_address_label": "Bitcoin (BTC) Address",
  "earnings.toast_min_amount": "Minimum withdrawal amount must be $20.00.",
  "earnings.toast_insufficient_balance": "Insufficient balance. Maximum available: $",
  "earnings.toast_invalid_address": "Please enter a valid wallet address.",
  "earnings.toast_payout_success": "Payout request submitted successfully! It will be transferred once approved by admin.",
  "earnings.toast_wallets_saved": "Wallet addresses saved successfully!",
  "earnings.toast_code_copied": "Referral code copied!",
  "earnings.toast_address_copied": "Wallet address copied!",
  "earnings.partner_badge": "WJ PARTNER PROGRAM",
  "earnings.partner_hero_title": "Grow Your Community, Earn From Every Subscription",
  "earnings.partner_hero_desc": "Earn passive income by introducing traders to the Wawe Journal ecosystem. Transparent commissions and crypto payouts anytime.",
  "earnings.step1_title": "1. Get Your Code",
  "earnings.step1_desc": "Once approved, a custom discount code is assigned for your followers with commission rights.",
  "earnings.step2_title": "2. Share & Grow",
  "earnings.step2_desc": "Your audience subscribes at a discount and levels up their trading with professional journaling.",
  "earnings.step3_title": "3. Crypto Payouts",
  "earnings.step3_desc": "Earn net $ commission on every subscription, withdraw your earnings via BTC or LTC anytime.",
  "earnings.btn_apply_partner": "Apply for Partner Program",
  "earnings.btn_reapply_partner": "Submit New Application",
  "earnings.app_pending_title": "Application Under Review",
  "earnings.app_pending_desc": "Your partner application is being reviewed by our team. Average review time is 24-48 hours.",
  "earnings.app_rejected_title": "Application Not Approved",
  "earnings.app_reapply_countdown": "You can submit a new application in: {{days}} days",
  "earnings.admin_reason": "Admin Note:",
  "earnings.modal_apply_title": "WJ Partner Application",
  "earnings.modal_apply_desc": "Tell us about your trading community or audience. Applications are reviewed within 24-48 hours.",
  "earnings.field_instagram": "Instagram Profile / Handle",
  "earnings.field_instagram_placeholder": "@username or instagram.com/username",
  "earnings.field_followers": "Follower / Community Size",
  "earnings.followers_opt_1": "1,000 - 5,000 Followers",
  "earnings.followers_opt_2": "5,000 - 20,000 Followers",
  "earnings.followers_opt_3": "20,000 - 50,000 Followers",
  "earnings.followers_opt_4": "50,000+ Followers",
  "earnings.field_crypto": "Do you use cryptocurrency?",
  "earnings.field_crypto_desc": "Affiliate commissions are paid via Bitcoin and Litecoin networks.",
  "earnings.crypto_yes": "Yes, I actively use crypto",
  "earnings.crypto_no": "No, not yet",
  "earnings.field_note": "Short Bio / Note",
  "earnings.field_note_placeholder": "Brief info about your content, trading analysis, and community...",
  "earnings.btn_submit_app": "Submit Application",
  "earnings.toast_app_submitted": "Partner application submitted successfully! Review status will appear on this page.",
  "earnings.toast_instagram_required": "Please enter your Instagram handle.",
  "earnings.toast_followers_required": "Please select your audience size."
};

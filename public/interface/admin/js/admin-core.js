...
function renderAdminPanel() {
  ...
  if (typeof initReferralModal === 'function') initReferralModal();
  ...
  if (typeof renderOverviewContent === 'function') renderOverviewContent(adminState.overviewPeriod || 'week');
  if (typeof renderUsersTable === 'function') renderUsersTable();
...
async function initAdmin() {
  try {
    ...
    try { await loadUsers(); } catch(e) { console.error('loadUsers hatası:', e); }
    try { await loadReferences(); } catch(e) { console.error('loadReferences hatası:', e); }
    try { await loadReferralCodes(); } catch(e) { console.error('loadReferralCodes hatası:', e); }
